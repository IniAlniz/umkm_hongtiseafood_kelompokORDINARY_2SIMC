    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="<?php echo e(route('admin.product-categories.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\umkm-hongtiseafood\resources\views/admin/product-categories/create.blade.php ENDPATH**/ ?>