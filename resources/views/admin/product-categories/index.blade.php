            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">                
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">                       
                        ...
                        <div> <a href="{{route('admin.product-categories.create')}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Product Category</a>
                        </div>
                        </div>
                                ...
                                @else
                                    @foreach ($productCategories as $productCategory)
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <a x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'confirm-product-category-deletion-{{$productCategory->id}}')" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-2">Delete</a>
